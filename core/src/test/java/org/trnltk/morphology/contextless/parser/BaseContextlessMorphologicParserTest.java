...
public abstract class BaseContextlessMorphologicParserTest {
    ...
    public void setUp() throws Exception {
        ...
        this.parser = buildParser(clonedRootMap);
    ...
    protected abstract ContextlessMorphologicParser buildParser(HashMultimap<String, Root> clonedRootMap);
    ...
    public LinkedList<MorphemeContainer> parse(String surfaceToParse) {
