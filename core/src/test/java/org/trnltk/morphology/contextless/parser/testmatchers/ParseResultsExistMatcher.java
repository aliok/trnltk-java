...
public class ParseResultsExistMatcher extends BaseParseResultsMatcher {

    private final List<String> expectedParseResults;

    public ParseResultsExistMatcher(String... expectedParseResults) {
    ...
    public void describeTo(Description description) {
        ...
        description.appendValueList("parse results containing <", ",", ">", this.expectedParseResults);
    }
