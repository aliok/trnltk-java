...
public class ContextlessMorphologicParserBasicSuffixGraphTest extends BaseContextlessMorphologicParserTest {
    ...
    protected ContextlessMorphologicParser buildParser(HashMultimap<String, Root> clonedRootMap) {
        return ContextlessMorphologicParserFactory.createSimpleWithRootMap(clonedRootMap);
    }
    ...
    public void shouldParseModals() {
        ...
        assertParseCorrectForVerb("elemeyeydim", "ele(elemek)+Verb+Neg(mA[me])+Opt(yAy[yey])+Past(dI[di])+A1sg(+Im[m])", "ele(elemek)+Verb+Neg(mA[me])+Opt(yA[ye])+Past(ydI[ydi])+A1sg(+Im[m])");
    ...
    public void shouldParsePronouns() {
        ...
        assertParseCorrect("nerede", "nere(nere)+Pron+Ques+A3sg+Pnon+Loc(dA[de])", "nerede(nerede)+Interj");
    ...
    public void shouldParseCausatives() {
        ...
        assertParseCorrectForVerb("ürküttüm", "ürk(ürkmek)+Verb+Verb+Caus(It[üt])+Pos+Past(dI[tü])+A1sg(+Im[m])");
        ...
        assertParseCorrectForVerb("korkutmamalı", "kork(korkmak)+Verb+Verb+Caus(It[ut])+Neg(mA[ma])+Neces(mAl!I[malı])+A3sg", "kork(korkmak)+Verb+Verb+Caus(It[ut])+Neg(mA[ma])+Noun+Inf(mA[ma])+A3sg+Pnon+Nom+Adj+With(lI[lı])", "kork(korkmak)+Verb+Verb+Caus(It[ut])+Neg(mA[ma])+Noun+Inf(mA[ma])+A3sg+Pnon+Nom+Adj+With(lI[lı])+Noun+Zero+A3sg+Pnon+Nom");
    ...
    public void shouldParseDoubleCausatives() {
        ...
        assertParseCorrectForVerb("ürküttürdüm", "ürk(ürkmek)+Verb+Verb+Caus(It[üt])+Verb+Caus(dIr[tür])+Pos+Past(dI[dü])+A1sg(+Im[m])");
    ...
    public void shouldParseTripleCausatives() {
        ...
        assertParseCorrectForVerb("ürküttürttüm", "ürk(ürkmek)+Verb+Verb+Caus(It[üt])+Verb+Caus(dIr[tür])+Verb+Caus(t[t])+Pos+Past(dI[tü])+A1sg(+Im[m])");
    ...
    public void shouldParseWordsWithSuffixesCe() {
        ...
        assertParseCorrect("sayıca",
                "sayıca(sayıca)+Noun+A3sg+Pnon+Nom",
    ...
    public void shouldParseDeYe() {
        removeRoots("der", "deri", "derle", "derd", "dirim", "diri");
    ...
    public void shouldParseSomeProblematicWords() {
        ...
        assertParseCorrectForVerb("deyip", "de(demek)+Verb+Pos+Adv+AfterDoingSo(+yIp[yip])");
