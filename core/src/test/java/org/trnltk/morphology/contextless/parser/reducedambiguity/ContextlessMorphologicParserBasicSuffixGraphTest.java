...
public class ContextlessMorphologicParserBasicSuffixGraphTest extends BaseContextlessMorphologicParserTest {
    ...
    public void shouldParsePositiveVerbTenses() {
        ...
        assertParseCorrect("yapacağım", "yap(yapmak)+Verb+Pos+Fut(+yAcAk[acağ])+A1sg(+Im[ım])", "yap(yapmak)+Verb+Pos+Adj+FutPart(+yAcAk[acağ])+P1sg(+Im[ım])");    // #2: yapacagimi aldi. yapacagini aldi A2sg icin
        assertParseCorrect("yapacaksın", "yap(yapmak)+Verb+Pos+Fut(+yAcAk[acak])+A2sg(sIn[sın])");
        assertParseCorrect("yapacak", "yap(yapmak)+Verb+Pos+Fut(+yAcAk[acak])+A3sg", "yap(yapmak)+Verb+Pos+Adj+FutPart(+yAcAk[acak])+Pnon");
        ...
        assertParseCorrect("yaptık", "yap(yapmak)+Verb+Pos+Past(dI[tı])+A1pl(!k[k])", "yap(yapmak)+Verb+Pos+Adj+PastPart(dIk[tık])+Pnon");
        ...
        assertParseCorrect("çevirmekte", "çevir(çevirmek)+Verb+Pos+Prog(mAktA[mekte])+A3sg", "çevir(çevirmek)+Verb+Pos+Noun+Inf(mAk[mek])+A3sg+Pnon+Loc(dA[te])");      // 2. durum ornek : etmekte birinci

        assertParseCorrect("çevireceğim", "çevir(çevirmek)+Verb+Pos+Fut(+yAcAk[eceğ])+A1sg(+Im[im])", "çevir(çevirmek)+Verb+Pos+Adj+FutPart(+yAcAk[eceğ])+P1sg(+Im[im])");
        assertParseCorrect("çevireceksin", "çevir(çevirmek)+Verb+Pos+Fut(+yAcAk[ecek])+A2sg(sIn[sin])");
        assertParseCorrect("çevirecek", "çevir(çevirmek)+Verb+Pos+Fut(+yAcAk[ecek])+A3sg", "çevir(çevirmek)+Verb+Pos+Adj+FutPart(+yAcAk[ecek])+Pnon");
        ...
        // TODO: reduce following into one suffix! duplicated by the following line
//        assertParseCorrect("elerim", "ele(elemek)+Verb+Pos+Aor(+Ir[r])+A1sg(+Im[im])", "ele(elemek)+Verb+Pos+Aor(+Ar[r])+A1sg(+Im[im])", "ele(elemek)+Verb+Pos+Aor(+Ir[r])+Adj+Zero+Noun+Zero+A3sg+P1sg(+Im[im])+Nom", "ele(elemek)+Verb+Pos+Aor(+Ar[r])+Adj+Zero+Noun+Zero+A3sg+P1sg(+Im[im])+Nom");
        ...
        assertParseCorrect("eleyeceğim", "ele(elemek)+Verb+Pos+Fut(+yAcAk[yeceğ])+A1sg(+Im[im])", "ele(elemek)+Verb+Pos+Adj+FutPart(+yAcAk[yeceğ])+P1sg(+Im[im])");
        assertParseCorrect("eleyeceksin", "ele(elemek)+Verb+Pos+Fut(+yAcAk[yecek])+A2sg(sIn[sin])");
        assertParseCorrect("eleyecek", "ele(elemek)+Verb+Pos+Fut(+yAcAk[yecek])+A3sg", "ele(elemek)+Verb+Pos+Adj+FutPart(+yAcAk[yecek])+Pnon");
    ...
    public void shouldParseNegativeVerbTenses() {
        ...
        assertParseCorrectForVerb("yapmayacağım", "yap(yapmak)+Verb+Neg(mA[ma])+Fut(+yAcAk[yacağ])+A1sg(+Im[ım])", "yap(yapmak)+Verb+Neg(mA[ma])+Adj+FutPart(+yAcAk[yacağ])+P1sg(+Im[ım])");
        assertParseCorrectForVerb("yapmayacaksın", "yap(yapmak)+Verb+Neg(mA[ma])+Fut(+yAcAk[yacak])+A2sg(sIn[sın])");
        assertParseCorrectForVerb("yapmayacak", "yap(yapmak)+Verb+Neg(mA[ma])+Fut(+yAcAk[yacak])+A3sg", "yap(yapmak)+Verb+Neg(mA[ma])+Adj+FutPart(+yAcAk[yacak])+Pnon");
        ...
        assertParseCorrectForVerb("yapmamış", "yap(yapmak)+Verb+Neg(mA[ma])+Narr(mIş[mış])+A3sg", "yap(yapmak)+Verb+Neg(mA[ma])+Narr(mIş[mış])+Adj+Zero");


        removeRoots("çevirme");
        assertParseCorrectForVerb("çevirmem", "çevir(çevirmek)+Verb+Neg(mA[me])+Aor+A1sg(+Im[m])", "çevir(çevirmek)+Verb+Pos+Noun+Inf(mA[me])+A3sg+P1sg(+Im[m])+Nom");
        assertParseCorrectForVerb("çevirmezsin", "çevir(çevirmek)+Verb+Neg(mA[me])+Aor(z[z])+A2sg(sIn[sin])");
        assertParseCorrectForVerb("çevirmez", "çevir(çevirmek)+Verb+Neg(mA[me])+Aor(z[z])+A3sg", "çevir(çevirmek)+Verb+Neg(mA[me])+Aor(z[z])+Adj+Zero");
        ...
        assertParseCorrectForVerb("çevirmeyeceğim", "çevir(çevirmek)+Verb+Neg(mA[me])+Fut(+yAcAk[yeceğ])+A1sg(+Im[im])", "çevir(çevirmek)+Verb+Neg(mA[me])+Adj+FutPart(+yAcAk[yeceğ])+P1sg(+Im[im])");
        assertParseCorrectForVerb("çevirmeyeceksin", "çevir(çevirmek)+Verb+Neg(mA[me])+Fut(+yAcAk[yecek])+A2sg(sIn[sin])");
        assertParseCorrectForVerb("çevirmeyecek", "çevir(çevirmek)+Verb+Neg(mA[me])+Fut(+yAcAk[yecek])+A3sg", "çevir(çevirmek)+Verb+Neg(mA[me])+Adj+FutPart(+yAcAk[yecek])+Pnon");
        ...
        assertParseCorrectForVerb("çevirmemiş", "çevir(çevirmek)+Verb+Neg(mA[me])+Narr(mIş[miş])+A3sg", "çevir(çevirmek)+Verb+Neg(mA[me])+Narr(mIş[miş])+Adj+Zero");
        ...
        assertParseCorrectForVerb("elemez", "ele(elemek)+Verb+Neg(mA[me])+Aor(z[z])+A3sg", "ele(elemek)+Verb+Neg(mA[me])+Aor(z[z])+Adj+Zero");
        ...
        assertParseCorrectForVerb("elemeyeceğim", "ele(elemek)+Verb+Neg(mA[me])+Fut(+yAcAk[yeceğ])+A1sg(+Im[im])", "ele(elemek)+Verb+Neg(mA[me])+Adj+FutPart(+yAcAk[yeceğ])+P1sg(+Im[im])");
        assertParseCorrectForVerb("elemeyeceksin", "ele(elemek)+Verb+Neg(mA[me])+Fut(+yAcAk[yecek])+A2sg(sIn[sin])");
        assertParseCorrectForVerb("elemeyecek", "ele(elemek)+Verb+Neg(mA[me])+Fut(+yAcAk[yecek])+A3sg", "ele(elemek)+Verb+Neg(mA[me])+Adj+FutPart(+yAcAk[yecek])+Pnon");
        ...
        assertParseCorrectForVerb("elememiş", "ele(elemek)+Verb+Neg(mA[me])+Narr(mIş[miş])+A3sg", "ele(elemek)+Verb+Neg(mA[me])+Narr(mIş[miş])+Adj+Zero");
    }
    ...
    public void shouldParsePositiveMultipleVerbTenses() {
        ...
        //TODO: reduce this one to followings assertParseCorrectForVerb("elerdim", "ele(elemek)+Verb+Pos+Aor(+Ir[r])+Past(dI[di])+A1sg(+Im[m])", "ele(elemek)+Verb+Pos+Aor(+Ar[r])+Past(dI[di])+A1sg(+Im[m])");
        assertParseCorrectForVerb("elerdim", "ele(elemek)+Verb+Pos+Aor(+r[r])+Past(dI[di])+A1sg(+Im[m])");
        assertParseCorrectForVerb("elerdin", "ele(elemek)+Verb+Pos+Aor(+r[r])+Past(dI[di])+A2sg(n[n])");
        assertParseCorrectForVerb("elerdi", "ele(elemek)+Verb+Pos+Aor(+r[r])+Past(dI[di])+A3sg");
        ...
        // TODO: reduce this one to followings assertParseCorrectForVerb("elermişim", "ele(elemek)+Verb+Pos+Aor(+Ir[r])+Narr(mIş[miş])+A1sg(+Im[im])", "ele(elemek)+Verb+Pos+Aor(+Ar[r])+Narr(mIş[miş])+A1sg(+Im[im])");
        assertParseCorrectForVerb("elermişim", "ele(elemek)+Verb+Pos+Aor(+r[r])+Narr(mIş[miş])+A1sg(+Im[im])");
        assertParseCorrectForVerb("elermişsin", "ele(elemek)+Verb+Pos+Aor(+r[r])+Narr(mIş[miş])+A2sg(sIn[sin])");
        assertParseCorrectForVerb("elermiş", "ele(elemek)+Verb+Pos+Aor(+r[r])+Narr(mIş[miş])+A3sg");
    ...
    public void shouldParseModals() {
        ...
        assertParseCorrectForVerb("eleyemeyeceğim", "ele(elemek)+Verb+Verb+Able(+yA[ye])+Neg(mA[me])+Fut(+yAcAk[yeceğ])+A1sg(+Im[im])", "ele(elemek)+Verb+Verb+Able(+yA[ye])+Neg(mA[me])+Adj+FutPart(+yAcAk[yeceğ])+P1sg(+Im[im])");
...
//                "sandalye(sandalye)+Noun+A3pl(lAr[ler])+P3sg(+sI[i])+Nom",      // TODO: reduction
...
//        );   // TODO
    ...
    public void shouldParsePronouns() {
        ...
        assertParseCorrect("nere(nere)+Pron+Ques+A3pl(lAr[ler])+P3sp(+sI[i])+Nom", "nereleri", "nere(nere)+Pron+Ques+A3pl(lAr[ler])+Pnon+Acc(+yI[i])");
