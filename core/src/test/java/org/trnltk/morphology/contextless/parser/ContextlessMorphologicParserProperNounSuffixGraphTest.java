...
public class ContextlessMorphologicParserProperNounSuffixGraphTest extends BaseContextlessMorphologicParserTest {
    ...
    @Override
    protected ContextlessMorphologicParser buildParser(final HashMultimap<String, Root> _unused) {
        ...
        return new ContextlessMorphologicParser(suffixGraph, null, Arrays.asList(properNounFromApostropheRootFinder, properNounWithoutApostropheRootFinder), suffixApplier);
    }
