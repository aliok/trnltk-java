...
public class RequiredTransitionApplierTest {
    ...
    public void shouldAddRequiredTransitions_forProgressiveVowelDrop() throws Exception {
        ...
        assertThat(retrievedList.get(0).getTransitions(), hasSize(2));
        assertThat(retrievedList.get(0).getTransitions().get(0).getSuffixFormApplication().getSuffixForm().getSuffix().getName(), equalTo("Pos"));
        assertThat(retrievedList.get(0).getTransitions().get(0).getSuffixFormApplication().getSuffixForm().getForm().getSuffixFormStr(), equalTo(""));
        assertThat(retrievedList.get(0).getTransitions().get(0).getSuffixFormApplication().getActualSuffixForm(), equalTo(""));
        assertThat(retrievedList.get(0).getTransitions().get(0).getSuffixFormApplication().getFittingSuffixForm(), equalTo(""));
        assertThat(retrievedList.get(0).getTransitions().get(1).getSuffixFormApplication().getSuffixForm().getSuffix().getName(), equalTo("Prog"));
        assertThat(retrievedList.get(0).getTransitions().get(1).getSuffixFormApplication().getSuffixForm().getForm().getSuffixFormStr(), equalTo("Iyor"));
        assertThat(retrievedList.get(0).getTransitions().get(1).getSuffixFormApplication().getActualSuffixForm(), equalTo("ıyor"));
        assertThat(retrievedList.get(0).getTransitions().get(1).getSuffixFormApplication().getFittingSuffixForm(), equalTo("ıyor"));
    }
