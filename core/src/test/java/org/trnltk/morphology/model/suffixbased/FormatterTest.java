...
public class FormatterTest {
    ...
    public void shouldFormatWithDerivationGrouping() {
        ...
        {
            final MorphemeContainer result = getFirstParseResult("kitaba");
            assertThat(Formatter.formatMorphemeContainerWithDerivationGrouping(result, false), equalTo("(\"kitap+Noun+A3sg+Pnon+Dat\")"));
        }
        {
            final MorphemeContainer result = getFirstParseResult("yaptırtmayı");
            assertThat(Formatter.formatMorphemeContainerWithDerivationGrouping(result, false), equalTo("(\"yap+Verb\")(\"Verb+Caus\")(\"Verb+Caus+Pos\")(\"Noun+Inf+A3sg+Pnon+Acc\")"));
        }
    }
    ...
    public void shouldFormatDetailed() throws JSONException {
        {
            final MorphemeContainer result = getFirstParseResult("kitaba");
            assertThat(Formatter.formatMorphemeContainerDetailed(result), equalTo("{\"Parts\":[{\"POS\":\"Noun\",\"Suffixes\":[\"A3sg\",\"Pnon\",\"Dat\"]}],\"LemmaRoot\":\"kitap\",\"RootPos\":\"Noun\",\"Root\":\"kitab\"}"));
        }
        {
            final MorphemeContainer result = getFirstParseResult("yaptırtmayı");
            assertThat(Formatter.formatMorphemeContainerDetailed(result), equalTo("{\"Parts\":[{\"POS\":\"Verb\"},{\"POS\":\"Verb\",\"Suffixes\":[\"Caus\"]},{\"POS\":\"Verb\",\"Suffixes\":[\"Caus\",\"Pos\"]},{\"POS\":\"Noun\",\"Suffixes\":[\"Inf\",\"A3sg\",\"Pnon\",\"Acc\"]}],\"LemmaRoot\":\"yap\",\"RootPos\":\"Verb\",\"Root\":\"yap\"}"));
        }
        {
            final MorphemeContainer result = getFirstParseResult("dördüncülükteki");
            assertThat(Formatter.formatMorphemeContainerDetailed(result), equalTo("{\"Parts\":[{\"POS\":\"Noun\",\"Suffixes\":[\"A3sg\",\"Pnon\",\"Nom\"]},{\"POS\":\"Adj\",\"Suffixes\":[\"Agt\"]},{\"POS\":\"Noun\",\"Suffixes\":[\"Ness\",\"A3sg\",\"Pnon\",\"Loc\"]},{\"POS\":\"Adj\",\"Suffixes\":[\"PointQual\"]}],\"LemmaRoot\":\"dördün\",\"RootPos\":\"Noun\",\"Root\":\"dördün\"}"));
        }
        {
            final MorphemeContainer result = getFirstParseResult("bu");
            assertThat(Formatter.formatMorphemeContainerDetailed(result), equalTo("{\"LemmaRoot\":\"bu\",\"RootPos\":\"Det\",\"Root\":\"bu\"}"));
        }
