...
import zemberek3.shared.tokenizer.experiment.data.TokenizerTrainingData;
import zemberek3.shared.tokenizer.experiment.data.TokenizerTrainingEntry;
...
public class TextTokenizerDefaultTraining {
    ...
    public void setUp() throws Exception {
        ...
        final Enumeration currentLoggers = Logger.getLogger("zemberek3").getLoggerRepository().getCurrentLoggers();
