...
/**
 * @deprecated Use {@link org.trnltk.morphology.contextless.parser.ContextlessMorphologicParser}
 */
public class ContextlessMorphologicParser implements MorphologicParser {
    ...
    public ContextlessMorphologicParser(final SuffixGraph suffixGraph, final PredefinedPathProvider predefinedPathProvider, final RootFinderChain rootFinderChain, final SuffixApplier suffixApplier) {
        this(suffixGraph, predefinedPathProvider, new AllowEverythingDisallowedPathProviderImpl(), rootFinderChain, suffixApplier);
    }

    public ContextlessMorphologicParser(final SuffixGraph suffixGraph, final PredefinedPathProvider predefinedPathProvider, final DisallowedPathProvider disallowedPathProvider, final RootFinderChain rootFinderChain, final SuffixApplier suffixApplier) {
