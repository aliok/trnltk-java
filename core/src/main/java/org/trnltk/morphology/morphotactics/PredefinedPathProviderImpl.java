...
public class PredefinedPathProviderImpl implements PredefinedPathProvider {
    ...
    public PredefinedPathProviderImpl(SuffixGraph suffixGraph, Multimap<String, ? extends Root> rootMap, SuffixApplier suffixApplier) {
