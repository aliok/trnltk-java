 ...
 */
public class PredefinedPathProviderRAImpl implements PredefinedPathProvider {
    ...
    public PredefinedPathProviderRAImpl(SuffixGraph suffixGraph, Multimap<String, ? extends Root> rootMap, SuffixApplier suffixApplier) {
