...
public class AmbigutyNumberTest {
...
//                .offer(properNounWithoutApostropheRootFinder, RootFinderChain.RootFinderPolicy.CONTINUE_ON_CHAIN)
    ...
    public void parse8MWords_withOfflineAnalysis() throws Exception {
        ...
        printFirst10KTopAmbiguousEntries(wordCountSet, resultMap, sortedTotalAmbiguityMap);

        completeProcessStopWatch.stop();
        System.out.println("It took " + completeProcessStopWatch.toString());
    }

    private void printFirst10KTopAmbiguousEntries(ImmutableMultiset<String> wordCountSet, Map<String, List<String>> resultMap, SortedMap<String, Integer> sortedTotalAmbiguityMap) {
        int i = 0;
